...
<body>
        ...
        <div class="container">
            ...
            <div class="cards">
                ...
                <a href="#" class="card">
                    ...
                    <img src="./img/dezinfect-1.png" alt="Пищевые аэрозоли" class="card-image">
                </a>
                <a href="#" class="card">
                    <div class="card-content">
                    ...
                    <img src="./img/avto-him-1.png" alt="Косметическая продукция" class="card-image">
                </a>
                <a href="#" class="card">
                    <div class="card-content">
                    ...
                    <img src="./img/bit-him-1.png" alt="Краски аэрозольные" class="card-image">
                </a>
            </div>
        </div>
    </section>
    <section class="section brand">
        <div class="container">
            <div class="separator"></div>
            <h2 class="section-title third">собственные марки</h2>
    ...
    <section class="section founder">
        <img src="./img/pexels-tiger-lily-44839381.png" alt="founder" class="founder-image">
        <div class="container">
